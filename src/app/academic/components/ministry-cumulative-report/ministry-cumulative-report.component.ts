...
@Component({
  selector: 'app-ministry-cumulative-report',
  templateUrl: './ministry-cumulative-report.component.html',
  styleUrls: ['./ministry-cumulative-report.component.scss']
})
export class MinistryCumulativeReportComponent implements OnInit {
    filter: any = {};
    $: any = $;
  ...
  load() {
    ...
    this.globalService.loadHtml("affair/report22", this.filter).subscribe((res) => {
